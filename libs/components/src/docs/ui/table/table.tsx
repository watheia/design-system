...
import { HeadingRow } from "@watheia/docs.ui.table-heading-row"
import { TableRow, RowType } from "@watheia/docs.ui.table-row"
...
export function Table({
  ...
  return (
    <div {...rest} className={classNames(styles.table, className)}>
      <HeadingRow isListView={isListView} colNumber={cols} headings={headings} />
