    ...
    <div {...props} className={classNames(props.className, text.center)}>
      <div className={classNames(textColumn, marginCenter)}>
        ...
        <Paragraph size={PossibleSizes.lg} className={styles.subtitle}>
          Bit empowers teams to deliver more often and faster to production while making
      ...
      >
        <div className={styles.text}>
          ...
          <Paragraph>
            ...
            component versions and release pipelines. Ship changes to many apps in a click.
          </Paragraph>
        </div>
        <Image
          alt="multi packagers"
        ...
        <div className={styles.text}>
          ...
          <Paragraph>
            Bit's component-driven CI propogates changes to all impacted components, in all
