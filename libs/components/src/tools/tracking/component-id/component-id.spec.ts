...
describe("component id", () => {
  ...
  describe("equality", () => {
    it("should equal when both are undefined", () => {
      expect(ComponentID.isEqual(undefined, undefined)).to.equal(true)
      expect(ComponentID.isEqualObj(undefined, undefined)).to.equal(true)
    })
    ...
    it("should not equal when one is undefined", () => {
      ...
      expect(ComponentID.isEqual(undefined, bId)).to.equal(false)
      expect(ComponentID.isEqualObj(undefined, bObj)).to.equal(false)
    })
    ...
    it("should equal when name and scope match", () => {
      ...
      expect(ComponentID.isEqual(aId, bId)).to.equal(true)
      expect(ComponentID.isEqualObj(aId, bId)).to.equal(true)
      expect(aId.isEqual(bId)).to.equal(true)
    })
    ...
    it("should equal when versions dont match, but ignored by options", () => {
      ...
      expect(ComponentID.isEqual(aId, bId, { ignoreVersion: true })).to.equal(true)
      expect(ComponentID.isEqualObj(aObj, bObj, { ignoreVersion: true })).to.equal(true)
      expect(aId.isEqual(bId, { ignoreVersion: true })).to.equal(true)
    })
    ...
    it("should not equal when versions dont match", () => {
      ...
      expect(ComponentID.isEqual(aId, bId)).to.equal(false)
      expect(ComponentID.isEqualObj(aObj, bObj)).to.equal(false)
      expect(aId.isEqual(bId)).to.equal(false)
    })
  })
