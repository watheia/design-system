...
import { colGrid, colGridL, colGridLg, colGridMd, colGridSm, colGridXl, colGridXs } from './grid-template';
...
export class Grid extends PureComponent<GridProps> {
  render() {
    ...
    return <div data-bit-id="teambit.base-ui/layout/grid-component" {...rest} className={classNames(...classes)} />;
  }
}
