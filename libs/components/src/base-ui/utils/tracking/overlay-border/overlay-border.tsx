...
import * as styles from "./overlay-border.module.scss"
import { ignorePopperSize } from "@watheia/base-ui.utils.popper-js.ignore-popper-size"
import { resizeToMatchReference } from "@watheia/base-ui.utils.popper-js.resize-to-match-reference"
...
export class OverlayBorder extends Component<ComponentBorderProps> {
  ...
  render() {
    ...
    return (
      <div {...rest} className={clsx(className, styles.overlayBorder)} ref={this.ref} />
    )
  }
}
