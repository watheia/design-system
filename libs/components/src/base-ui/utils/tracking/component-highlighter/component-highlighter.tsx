...
import * as styles from "./component-highlighter.module.scss"
import { RefTooltip } from "@watheia/base-ui.gfx.ref-tooltip"
import * as baseUiUtilsTrackingOverlayBorder from "@watheia/base-ui.utils.tracking.overlay-border"
import { VersionMap } from "./content-type"
import { ComponentLabel } from "@watheia/base-ui.utils.tracking.component-label"
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <baseUiUtilsTrackingOverlayBorder.OverlayBorder
          targetElement={targetElement}
